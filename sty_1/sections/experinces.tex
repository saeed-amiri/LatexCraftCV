...
\vspace{-0.83em}
\begin{zitemize}
\item \textbf{Production-standard engineering: Data science, algorithmic optimization, and MLOps:}
\begin{itemize}
    \item MongoDB, NonSQL, Cloud (AWS), Docker, Kubernetes, Airflow, MLflow and FastAPI
    ...
    \item API security, logging, Prometheus, and Grafana, Nginx
\end{itemize}
\end{zitemize}
...
\vspace{-0.63em}
\begin{zitemize}
  \item \textbf{Developing classical MD and numerical models for complex experimental systems (GROMACS, LAMMPS)}:
  \begin{itemize}
    ...
    \item Experimental Collaboration: At \textbf{ESRF} (Grenoble) and \textbf{DESY} (Hamburg), to support synchrotron X-ray measurements.
